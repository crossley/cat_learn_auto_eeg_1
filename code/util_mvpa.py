#!/usr/bin/env python3
"""Shared MVPA temporal-generalization helpers."""
...
def run_mvpa_stim_locked_cat_tg_within_day(
    ...
    within_subject_csv = output_dir / "mvpa_stim_locked_cat_tg_within_day_subject_level.csv"
    within_day_mean_csv = output_dir / "mvpa_stim_locked_cat_tg_within_day_day_mean.csv"
    qc_csv = output_dir / "mvpa_stim_locked_cat_tg_within_day_qc_log.csv"
