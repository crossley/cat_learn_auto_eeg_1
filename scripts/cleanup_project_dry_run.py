...
KEEP_FIGURES = {
    ...
    "erp_gfp_stim_all.png",
    "erp_model_timecourse.png",
    "mvpa_block_model_timecourse_difficulty.png",
    ...
    "mvpa_stim_locked_cat_difficulty_roi_time_resolved_auc.png",
    "mvpa_stim_locked_cat_difficulty_time_resolved_auc.png",
    "mvpa_stim_locked_cat_peak_and_behavior.png",
    "mvpa_stim_locked_cat_roi_time_resolved_auc.png",
    "mvpa_stim_locked_cat_time_resolved_auc.png",
    "mvpa_stim_locked_cat_tg_timegen_matrices_5x5.png",
    "mvpa_stim_locked_cat_window_transfer_model_predictions.png",
    ...
    "rnn_mvpa_gru_early_exit_auc.png",
    "rnn_mvpa_gru_model_timecourse.png",
    "rnn_mvpa_gru_transfer_matrices.png",
...
KEEP_CODE_FILES = {
    ...
    "mvpa_block_model_timecourse_difficulty_analysis.py",
    "mvpa_block_model_timecourse_difficulty_figure.py",
    ...
    "mvpa_stim_locked_cat_difficulty_analysis.py",
    "mvpa_stim_locked_cat_difficulty_figure.py",
    "mvpa_stim_locked_cat_difficulty_roi_analysis.py",
    "mvpa_stim_locked_cat_difficulty_roi_figure.py",
    ...
    "mvpa_stim_locked_cat_time_resolved_figure.py",
